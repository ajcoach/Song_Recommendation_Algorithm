# -*- coding: utf-8 -*-
"""
Created on Tue Oct 19 19:17:39 2021
...
""" Output
feature_0000  994623  0.15498176001746336  0.06646213086143025        0.0     0.959
...
feature_0006  994623    27.46386798784071    8.352648595163766        0.0     117.0
feature_0007  994623   1495.8091812075545   505.89376391902306        0.0    5834.0
feature_0008  994623   143165.46163257837   50494.276171032274  -146300.0  452500.0
feature_0009  994623  2.396783048473542E7    9307340.299219666        0.0   9.477E7
"""


# Getting correlations between features
...
# Printing the correlations in pairs
...
""" Output
(0, 5) 0.754207868124561
(1, 2) 0.8575486565280156
(1, 3) 0.6095209087098502
(2, 3) 0.8030096521046058
(2, 4) 0.6829093525782369
(3, 4) 0.9422444252722715
(5, 6) 0.549015222186825
(5, 7) 0.5185026975023406
(6, 7) 0.9033667462436238
(6, 8) 0.5164990583386245
(7, 8) 0.77280689539197
(7, 9) 0.6856452835776945
(8, 9) 0.984866503780647
"""
...
# Grouping by genre_type and showing the ocunt under each
...
genre_plot = genre.groupBy('genre_type').count()

genre_plot.write.mode("overwrite").csv('./Assignment2/genre_types.csv')


# Saving the csv to local in HDFS

# In HDFS
hdfs dfs -copyToLocal ./Assignment2/genre_types.csv ./
#


# Copying to to local machine and combining to one csv

# In local Windows Command Prompt
cd "C:\Users\coach\OneDrive - University of Canterbury\MADS\DATA420 Assignment 2 Code\genre_types.csv"
copy *.csv combined_genre_types.csv
#

""" Output
part-00000-ce179f64-d6e3-48d1-8124-94fcc9c151fd-c000.csv
part-00001-ce179f64-d6e3-48d1-8124-94fcc9c151fd-c000.csv
part-00002-ce179f64-d6e3-48d1-8124-94fcc9c151fd-c000.csv
part-00003-ce179f64-d6e3-48d1-8124-94fcc9c151fd-c000.csv
part-00004-ce179f64-d6e3-48d1-8124-94fcc9c151fd-c000.csv
part-00005-ce179f64-d6e3-48d1-8124-94fcc9c151fd-c000.csv
part-00006-ce179f64-d6e3-48d1-8124-94fcc9c151fd-c000.csv
part-00008-ce179f64-d6e3-48d1-8124-94fcc9c151fd-c000.csv
part-00009-ce179f64-d6e3-48d1-8124-94fcc9c151fd-c000.csv
part-00010-ce179f64-d6e3-48d1-8124-94fcc9c151fd-c000.csv
part-00013-ce179f64-d6e3-48d1-8124-94fcc9c151fd-c000.csv
part-00014-ce179f64-d6e3-48d1-8124-94fcc9c151fd-c000.csv
part-00015-ce179f64-d6e3-48d1-8124-94fcc9c151fd-c000.csv
        1 file(s) copied.
"""
